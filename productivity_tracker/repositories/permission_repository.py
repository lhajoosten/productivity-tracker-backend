...
class PermissionRepository(BaseRepository[Permission]):
    ...
    def get_by_name(self, name: str) -> Permission | None:
        ...
        return cast(
            ...
            .filter(Permission.name == name, Permission.is_deleted.is_(False))  # noqa: E712
            .first(),
        )

    def get_by_resource_and_action(self, resource: str, action: str) -> Permission | None:
    ...
    def get_by_resource(self, resource: str) -> list[Permission]:
        ...
        return cast(
            list[Permission],
            self.db.query(Permission)
            .filter(Permission.resource == resource, Permission.is_deleted.is_(False))  # noqa: E712
            .all(),
        )
    ...
    def get_by_action(self, action: str) -> list[Permission]:
        ...
        return cast(
            list[Permission],
            self.db.query(Permission)
            .filter(Permission.action == action, Permission.is_deleted.is_(False))  # noqa: E712
            .all(),
        )
